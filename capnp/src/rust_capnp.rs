...
pub mod value {
  pub const ID: u64 = 0xe6a91b805f553e8f;
  pub fn get_type() -> crate::introspect::Type { <crate::rust_capnp::value_opts::Owned as crate::introspect::Introspect>::introspect() }
}
...
pub mod value_opts {
  ...
  impl <'a,> Reader<'a,>  {
    ...
    #[inline]
    pub fn get_type(self) -> crate::Result<crate::text::Reader<'a>> {
      crate::traits::FromPointerReader::get_from_pointer(&self.reader.get_pointer_field(0), None)
    }
    #[inline]
    ...
    #[inline]
    pub fn get_from(self) -> crate::Result<Option<crate::text::Reader<'a>>> {
      if self.reader.get_pointer_field(1).is_null() {
        Ok(None)
      } else {
        crate::traits::FromPointerReader::get_from_pointer(&self.reader.get_pointer_field(1), None).map(Some)
      }
    }
    #[inline]
    ...
    #[inline]
    pub fn get_to(self) -> crate::Result<Option<crate::text::Reader<'a>>> {
      if self.reader.get_pointer_field(2).is_null() {
        Ok(None)
      } else {
        crate::traits::FromPointerReader::get_from_pointer(&self.reader.get_pointer_field(2), None).map(Some)
      }
    }
    #[inline]
  ...
  impl <'a,> crate::traits::HasStructSize for Builder<'a,>  {
    const STRUCT_SIZE: crate::private::layout::StructSize = crate::private::layout::StructSize { data: 0, pointers: 3 };
  }
  ...
  impl <'a,> Builder<'a,>  {
    ...
    #[inline]
    pub fn get_type(self) -> crate::Result<crate::text::Builder<'a>> {
      crate::traits::FromPointerBuilder::get_from_pointer(self.builder.get_pointer_field(0), None)
    }
    #[inline]
    pub fn set_type(&mut self, value: crate::text::Reader<'_>)  {
      self.builder.reborrow().get_pointer_field(0).set_text(value);
    }
    #[inline]
    pub fn init_type(self, size: u32) -> crate::text::Builder<'a> {
    ...
    #[inline]
    pub fn get_from(self) -> crate::Result<crate::text::Builder<'a>> {
      crate::traits::FromPointerBuilder::get_from_pointer(self.builder.get_pointer_field(1), None)
    }
    #[inline]
    pub fn set_from(&mut self, value: crate::text::Reader<'_>)  {
      self.builder.reborrow().get_pointer_field(1).set_text(value);
    }
    #[inline]
    pub fn init_from(self, size: u32) -> crate::text::Builder<'a> {
    ...
    #[inline]
    pub fn get_to(self) -> crate::Result<crate::text::Builder<'a>> {
      crate::traits::FromPointerBuilder::get_from_pointer(self.builder.get_pointer_field(2), None)
    }
    #[inline]
    pub fn set_to(&mut self, value: crate::text::Reader<'_>)  {
      self.builder.reborrow().get_pointer_field(2).set_text(value);
    }
    #[inline]
    pub fn init_to(self, size: u32) -> crate::text::Builder<'a> {
  ...
  mod _private {
    pub static ENCODED_NODE: [crate::Word; 78] = [
      ...
      crate::word(79, 112, 116, 115, 0, 0, 0, 0),
      ...
      crate::word(73, 0, 0, 0, 31, 0, 0, 0),
      crate::word(100, 0, 0, 0, 3, 0, 1, 0),
      crate::word(112, 0, 0, 0, 2, 0, 1, 0),
      crate::word(2, 0, 0, 0, 2, 0, 0, 0),
      crate::word(0, 0, 1, 0, 2, 0, 0, 0),
      crate::word(0, 0, 0, 0, 0, 0, 0, 0),
      crate::word(109, 0, 0, 0, 26, 0, 0, 0),
      crate::word(109, 0, 0, 0, 31, 0, 0, 0),
      crate::word(136, 0, 0, 0, 3, 0, 1, 0),
      crate::word(148, 0, 0, 0, 2, 0, 1, 0),
      ...
      crate::word(0, 0, 0, 0, 0, 0, 0, 0),
      crate::word(0, 0, 0, 0, 0, 0, 0, 0),
      crate::word(102, 114, 111, 109, 0, 0, 0, 0),
      crate::word(4, 0, 0, 0, 1, 0, 2, 0),
      crate::word(78, 150, 225, 78, 44, 242, 254, 171),
      crate::word(4, 0, 0, 0, 2, 0, 1, 0),
      crate::word(12, 0, 0, 0, 0, 0, 1, 0),
      crate::word(0, 0, 0, 0, 0, 0, 0, 0),
      crate::word(0, 0, 0, 0, 0, 0, 0, 0),
      crate::word(0, 0, 0, 0, 0, 0, 0, 0),
      crate::word(0, 0, 0, 0, 0, 0, 0, 0),
      ...
      crate::word(0, 0, 0, 0, 0, 0, 0, 0),
      crate::word(0, 0, 0, 0, 0, 0, 0, 0),
      crate::word(116, 111, 0, 0, 0, 0, 0, 0),
      crate::word(4, 0, 0, 0, 1, 0, 2, 0),
      crate::word(78, 150, 225, 78, 44, 242, 254, 171),
      crate::word(4, 0, 0, 0, 2, 0, 1, 0),
      crate::word(12, 0, 0, 0, 0, 0, 1, 0),
    ...
    pub fn get_field_types(index: u16) -> crate::introspect::Type {
      match index {
        ...
        2 => <crate::text::Owned as crate::introspect::Introspect>::introspect(),
        _ => panic!("invalid field index {}", index),
      }
    }
    pub fn get_annotation_types(child_index: Option<u16>, index: u32) -> crate::introspect::Type {
        match (child_index, index) {
          (Some(1), 0) => <() as crate::introspect::Introspect>::introspect(),
          (Some(2), 0) => <() as crate::introspect::Introspect>::introspect(),
    ...
    pub const TYPE_ID: u64 = 0xf553_a079_7690_3d8b;
  }
}
pub mod internal {
  pub const ID: u64 = 0xedd5eeecba647642;
  pub fn get_type() -> crate::introspect::Type { <() as crate::introspect::Introspect>::introspect() }
}
